...
ex_warm () {
        ...
        echo "$(eval_gettext 'Heater outlet control set to 100 parsent inlet control set to 0 parsent')"
...
ex_set_value () {
        ...
        printf "$(eval_gettext 'Sets the value of %s to %s')" "$register" "value"
        ...
        printf "$(eval_gettext 'The value of %s is now %s')" "$register" "$v"
...
ex_pid_schedule () {
        ...
        do
                ...
                do
                        ...
                        #実験時間
                        r_etime=`shuf -i 1-7 -n1`

                        printf "$(eval_gettext 'Load factor:%s parsent Experiment time:%s h')\n" "$r_schedule" "$r_etime"
